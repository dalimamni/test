...
<head>
    ...
    <title>Product Discount | Nalika - Material Admin Template</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product Discount" href="product-edit.php"><span class="mini-sub-pro">Product Discount</span></a></li>
                                <li><a title="Product Detail" href="product-detail.php"><span class="mini-sub-pro">Product Publicity</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit.html">Product Discount</a></li>
                                                <li><a href="product-detail.html">Product Publicity</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-report">
											<a href="imprimer.php"><button data-toggle="tooltip" data-placement="left" title="Download Report" class="btn"><i class="icon nalika-download"></i></button></a>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Product Discount</a></li>
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <form method="POST" action="ajouterpromo.php" onsubmit="return validation()">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="code"name="code" id="code" autocomplete="off" pattern="[0-9]{1,}" required ><span id="codee" class="text-danger font-weight-bold"></span>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Product Title" name="title" id="title"  autocomplete="off" pattern="[A-Za-z]{1,}" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" placeholder="Discount" id="discount"name="discount" autocomplete="off" pattern="[0-9]{1,}" required><span id="discountt" class="text-danger font-weight-bold"></span>
                                                    </div>
                                                 
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" placeholder="Price" id="price"name="price" autocomplete="off" pattern="[0-9]{1,}" required>
                                                        <span id="pricee" class="text-danger font-weight-bold"></span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    ...
                                                    <input type="submit" class="btn btn-ctl-bt waves-effect waves-light" name="ajouter" value="ajouter" autocomplete="off" >
...
if (code<0) {
    ...
    document.getElementById('codee').innerHTML="fffffffffff";
    return false;
}
if (discount<0) {


    document.getElementById('discountt').innerHTML="fffffffffff";
    return false;
}
if (price<0) {


    document.getElementById('pricee').innerHTML="fffffffffff";
    return false;
}
}
