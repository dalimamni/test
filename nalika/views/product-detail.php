...
<head>
    ...
    <title>Product Publicity | Nalika - Material Admin Template</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product Edit" href="product-edit.php"><span class="mini-sub-pro">Product Discount</span></a></li>
...
<?php
  ...
  if(count(fetchAll($query))>0);
  {
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit.html">Product Dicount</a></li>
									...
									<div class="single-product-details res-pro-tb">
										...
										<div class="color-quality-pro">
											...
											<div class="single-pro-button">
                                                       ...
                                                       <h1> <label for="fileSelect">Filename:</label></h1>
                                                            <span class="btn btn-primary btn-file">
                                                                 Browse <input type="file" name="photo" id="image">
                                                                                    </span>
                                                          <input type="submit" name="submit" class="btn btn-success" value="Upload" onclick="notifyMe()">
                                                      </form>
   ...
   $('#image').change(function(){ 
       ...
       contentType: false,
        beforeSend: function(){
         $('#myTabContent1').html('Loading...');
        },
        success: function(data){ 
         // alert(data);            
                   $('#myTabContent1').html('<img  src="'+data+'" style="width:100%"/>');  
